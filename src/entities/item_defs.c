...
const ItemDef itemDefs[ITEM_TYPE_COUNT] = {
    ...
    [ITEM_BARK]         = { "Bark",         SPRITE_tree_bark_oak, IF_STACKABLE | IF_FUEL, 20 },
    [ITEM_STRIPPED_LOG] = { "Stripped Log",  SPRITE_tree_stripped_log_oak, IF_STACKABLE | IF_BUILDING_MAT | IF_FUEL, 20 },
};
