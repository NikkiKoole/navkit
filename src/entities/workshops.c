...
// Recipe format: { name, input1, count1, input2, count2, input3, count3, output, outCount, output2, outCount2, workRequired, passiveWorkRequired, matMatch, mat, fuel, itemMatch }
...
Recipe sawmillRecipes[] = {
    { "Saw Planks",    ITEM_LOG, 1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_PLANKS, 4, ITEM_NONE, 0, 1.6f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Cut Sticks",    ITEM_LOG, 1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_STICKS, 8, ITEM_NONE, 0, 0.8f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Strip Bark",    ITEM_LOG, 1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_STRIPPED_LOG, 1, ITEM_BARK, 2, 1.6f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Saw Stripped",  ITEM_STRIPPED_LOG, 1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_PLANKS, 5, ITEM_NONE, 0, 1.6f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Build Chest",   ITEM_PLANKS, 4, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_CHEST, 1, ITEM_NONE, 0, 2.4f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
};
int sawmillRecipeCount = sizeof(sawmillRecipes) / sizeof(sawmillRecipes[0]);

// Kiln recipes: fire processing with fuel
Recipe kilnRecipes[] = {
    { "Fire Bricks",   ITEM_CLAY, 1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_BRICKS,   2, ITEM_NONE, 0, 2.0f, 0, MAT_MATCH_ANY, MAT_NONE, 1, ITEM_MATCH_EXACT, 0, 0 },
...
Recipe charcoalPitRecipes[] = {
    { "Char Logs",   ITEM_LOG,    1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_CHARCOAL, 2, ITEM_NONE, 0, 0.8f, 24.0f, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Char Peat",   ITEM_PEAT,   1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_CHARCOAL, 2, ITEM_NONE, 0, 0.8f, 20.0f, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Char Sticks", ITEM_STICKS, 4, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_CHARCOAL, 1, ITEM_NONE, 0, 0.8f, 16.0f, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
};
...
Recipe campfireRecipes[] = {
    ...
    { "Brew Tea",     ITEM_WATER, 1, ITEM_DRIED_GRASS, 2, ITEM_NONE, 0, ITEM_HERBAL_TEA, 1, ITEM_NONE, 0, 1.0f, 10.0f, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
    { "Press Juice",  ITEM_WATER, 1, ITEM_BERRIES, 3, ITEM_NONE, 0, ITEM_BERRY_JUICE, 2, ITEM_NONE, 0, 1.0f, 10.0f, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
};
...
Recipe ropeMakerRecipes[] = {
    { "Twist Bark",    ITEM_BARK, 2,         ITEM_NONE, 0, ITEM_NONE, 0, ITEM_SHORT_STRING, 3, ITEM_NONE, 0, 1.2f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, 0, 0 },
...
Recipe carpenterRecipes[] = {
    ...
    { "Craft Digging Stick", ITEM_STICKS, 1, ITEM_NONE, 0, ITEM_NONE, 0, ITEM_DIGGING_STICK, 1, ITEM_NONE, 0, 2.0f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, QUALITY_CUTTING, 1 },
    { "Craft Stone Hammer", ITEM_ROCK, 1, ITEM_STICKS, 1, ITEM_CORDAGE, 1, ITEM_STONE_HAMMER, 1, ITEM_NONE, 0, 4.0f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, QUALITY_CUTTING, 1 },
    { "Craft Stone Axe",   ITEM_ROCK, 1, ITEM_STICKS, 1, ITEM_CORDAGE, 1, ITEM_STONE_AXE, 1, ITEM_NONE, 0, 4.0f, 0, MAT_MATCH_ANY, MAT_NONE, 0, ITEM_MATCH_EXACT, QUALITY_CUTTING, 1 },
