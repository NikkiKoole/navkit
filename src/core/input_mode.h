...
typedef enum {
    ...
    ACTION_DRAW_WORKSHOP_QUERN,
    ACTION_DRAW_WORKSHOP_LOOM,
    ...
    ACTION_WORK_WORKSHOP_ROPE_MAKER,
    ACTION_WORK_WORKSHOP_CHARCOAL_PIT,
    ACTION_WORK_WORKSHOP_HEARTH,
    ACTION_WORK_WORKSHOP_STONECUTTER,
    ...
    ACTION_WORK_WORKSHOP_QUERN,
    ACTION_WORK_WORKSHOP_LOOM,
    ...
    ACTION_WORK_GATHER,
    // Work > Explore (top-level, no submode)
    ACTION_WORK_EXPLORE,
