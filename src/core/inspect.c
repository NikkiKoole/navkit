...
int InspectSaveFile(int argc, char** argv) {
    ...
    if (version >= 77) {
        ...
        fseek(f, totalCells * sizeof(FarmCellV76), SEEK_CUR);  // farmGrid (4 bytes per cell)
        fseek(f, sizeof(int), SEEK_CUR);  // farmActiveCells
    }
    ...
    if (version == 31) {
        ...
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            ...
            insp_stockpiles[i].x = v65_sp.x;
            insp_stockpiles[i].y = v65_sp.y;
            insp_stockpiles[i].z = v65_sp.z;
            insp_stockpiles[i].width = v65_sp.width;
            insp_stockpiles[i].height = v65_sp.height;
            insp_stockpiles[i].active = v65_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v65_sp.allowedTypes,
                   sizeof(v65_sp.allowedTypes));
            for (int t = V65_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v65_sp.allowedMaterials,
                   sizeof(v65_sp.allowedMaterials));
            memcpy(insp_stockpiles[i].cells, v65_sp.cells, sizeof(v65_sp.cells));
            memcpy(insp_stockpiles[i].slots, v65_sp.slots, sizeof(v65_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v65_sp.reservedBy, sizeof(v65_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v65_sp.slotCounts, sizeof(v65_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v65_sp.slotTypes, sizeof(v65_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v65_sp.slotMaterials, sizeof(v65_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v65_sp.maxStackSize;
            insp_stockpiles[i].priority = v65_sp.priority;
            insp_stockpiles[i].maxContainers = v65_sp.maxContainers;
        ...
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            ...
            insp_stockpiles[i].x = v67_sp.x;
            insp_stockpiles[i].y = v67_sp.y;
            insp_stockpiles[i].z = v67_sp.z;
            insp_stockpiles[i].width = v67_sp.width;
            insp_stockpiles[i].height = v67_sp.height;
            insp_stockpiles[i].active = v67_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v67_sp.allowedTypes,
                   sizeof(v67_sp.allowedTypes));
            for (int t = V67_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v67_sp.allowedMaterials,
                   sizeof(v67_sp.allowedMaterials));
            memcpy(insp_stockpiles[i].cells, v67_sp.cells, sizeof(v67_sp.cells));
            memcpy(insp_stockpiles[i].slots, v67_sp.slots, sizeof(v67_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v67_sp.reservedBy, sizeof(v67_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v67_sp.slotCounts, sizeof(v67_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v67_sp.slotTypes, sizeof(v67_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v67_sp.slotMaterials, sizeof(v67_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v67_sp.maxStackSize;
            insp_stockpiles[i].priority = v67_sp.priority;
            insp_stockpiles[i].maxContainers = v67_sp.maxContainers;
        ...
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            ...
            insp_stockpiles[i].x = v69_sp.x;
            insp_stockpiles[i].y = v69_sp.y;
            insp_stockpiles[i].z = v69_sp.z;
            insp_stockpiles[i].width = v69_sp.width;
            insp_stockpiles[i].height = v69_sp.height;
            insp_stockpiles[i].active = v69_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v69_sp.allowedTypes,
                   sizeof(v69_sp.allowedTypes));
            for (int t = V69_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v69_sp.allowedMaterials,
                   sizeof(v69_sp.allowedMaterials));
            memcpy(insp_stockpiles[i].cells, v69_sp.cells, sizeof(v69_sp.cells));
            memcpy(insp_stockpiles[i].slots, v69_sp.slots, sizeof(v69_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v69_sp.reservedBy, sizeof(v69_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v69_sp.slotCounts, sizeof(v69_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v69_sp.slotTypes, sizeof(v69_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v69_sp.slotMaterials, sizeof(v69_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v69_sp.maxStackSize;
            insp_stockpiles[i].priority = v69_sp.priority;
            insp_stockpiles[i].maxContainers = v69_sp.maxContainers;
        ...
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            ...
            insp_stockpiles[i].x = v76_sp.x;
            insp_stockpiles[i].y = v76_sp.y;
            insp_stockpiles[i].z = v76_sp.z;
            insp_stockpiles[i].width = v76_sp.width;
            insp_stockpiles[i].height = v76_sp.height;
            insp_stockpiles[i].active = v76_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v76_sp.allowedTypes,
                   sizeof(v76_sp.allowedTypes));
            for (int t = V76_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v76_sp.allowedMaterials,
                   sizeof(v76_sp.allowedMaterials));
            memcpy(insp_stockpiles[i].cells, v76_sp.cells, sizeof(v76_sp.cells));
            memcpy(insp_stockpiles[i].slots, v76_sp.slots, sizeof(v76_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v76_sp.reservedBy, sizeof(v76_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v76_sp.slotCounts, sizeof(v76_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v76_sp.slotTypes, sizeof(v76_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v76_sp.slotMaterials, sizeof(v76_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v76_sp.maxStackSize;
            insp_stockpiles[i].priority = v76_sp.priority;
            insp_stockpiles[i].maxContainers = v76_sp.maxContainers;
            memcpy(insp_stockpiles[i].slotIsContainer, v76_sp.slotIsContainer, sizeof(v76_sp.slotIsContainer));
            memcpy(insp_stockpiles[i].groundItemIdx, v76_sp.groundItemIdx, sizeof(v76_sp.groundItemIdx));
            insp_stockpiles[i].freeSlotCount = v76_sp.freeSlotCount;
            insp_stockpiles[i].rejectsRotten = v76_sp.rejectsRotten;
        }
    } else if (version < 78) {
        ...
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            ...
            insp_stockpiles[i].x = v77_sp.x;
            insp_stockpiles[i].y = v77_sp.y;
            insp_stockpiles[i].z = v77_sp.z;
            insp_stockpiles[i].width = v77_sp.width;
            insp_stockpiles[i].height = v77_sp.height;
            insp_stockpiles[i].active = v77_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v77_sp.allowedTypes,
                   sizeof(v77_sp.allowedTypes));
            for (int t = V77_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v77_sp.allowedMaterials,
                   sizeof(v77_sp.allowedMaterials));
            memcpy(insp_stockpiles[i].cells, v77_sp.cells, sizeof(v77_sp.cells));
            memcpy(insp_stockpiles[i].slots, v77_sp.slots, sizeof(v77_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v77_sp.reservedBy, sizeof(v77_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v77_sp.slotCounts, sizeof(v77_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v77_sp.slotTypes, sizeof(v77_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v77_sp.slotMaterials, sizeof(v77_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v77_sp.maxStackSize;
            insp_stockpiles[i].priority = v77_sp.priority;
            insp_stockpiles[i].maxContainers = v77_sp.maxContainers;
            memcpy(insp_stockpiles[i].slotIsContainer, v77_sp.slotIsContainer, sizeof(v77_sp.slotIsContainer));
            memcpy(insp_stockpiles[i].groundItemIdx, v77_sp.groundItemIdx, sizeof(v77_sp.groundItemIdx));
        ...
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            ...
            insp_stockpiles[i].x = v79_sp.x;
            insp_stockpiles[i].y = v79_sp.y;
            insp_stockpiles[i].z = v79_sp.z;
            insp_stockpiles[i].width = v79_sp.width;
            insp_stockpiles[i].height = v79_sp.height;
            insp_stockpiles[i].active = v79_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v79_sp.allowedTypes,
                   sizeof(v79_sp.allowedTypes));
            for (int t = V79_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v79_sp.allowedMaterials,
                   sizeof(v79_sp.allowedMaterials));
            for (int m = V79_MAT_COUNT; m < MAT_COUNT; m++) {
                insp_stockpiles[i].allowedMaterials[m] = true;
            }
            memcpy(insp_stockpiles[i].cells, v79_sp.cells, sizeof(v79_sp.cells));
            memcpy(insp_stockpiles[i].slots, v79_sp.slots, sizeof(v79_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v79_sp.reservedBy, sizeof(v79_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v79_sp.slotCounts, sizeof(v79_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v79_sp.slotTypes, sizeof(v79_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v79_sp.slotMaterials, sizeof(v79_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v79_sp.maxStackSize;
            insp_stockpiles[i].priority = v79_sp.priority;
            insp_stockpiles[i].maxContainers = v79_sp.maxContainers;
            memcpy(insp_stockpiles[i].slotIsContainer, v79_sp.slotIsContainer, sizeof(v79_sp.slotIsContainer));
            memcpy(insp_stockpiles[i].groundItemIdx, v79_sp.groundItemIdx, sizeof(v79_sp.groundItemIdx));
            insp_stockpiles[i].freeSlotCount = v79_sp.freeSlotCount;
            insp_stockpiles[i].rejectsRotten = v79_sp.rejectsRotten;
        }
    } else if (version < 81) {
        // v80: 67 item types, migrate to current (adding 2 items)
        StockpileV80 v80_sp;
        for (int i = 0; i < MAX_STOCKPILES; i++) {
            fread(&v80_sp, sizeof(StockpileV80), 1, f);
            insp_stockpiles[i].x = v80_sp.x;
            insp_stockpiles[i].y = v80_sp.y;
            insp_stockpiles[i].z = v80_sp.z;
            insp_stockpiles[i].width = v80_sp.width;
            insp_stockpiles[i].height = v80_sp.height;
            insp_stockpiles[i].active = v80_sp.active;
            memcpy(insp_stockpiles[i].allowedTypes, v80_sp.allowedTypes,
                   sizeof(v80_sp.allowedTypes));
            for (int t = V80_ITEM_TYPE_COUNT; t < ITEM_TYPE_COUNT; t++) {
                insp_stockpiles[i].allowedTypes[t] = true;
            }
            memcpy(insp_stockpiles[i].allowedMaterials, v80_sp.allowedMaterials,
                   sizeof(v80_sp.allowedMaterials));
            memcpy(insp_stockpiles[i].cells, v80_sp.cells, sizeof(v80_sp.cells));
            memcpy(insp_stockpiles[i].slots, v80_sp.slots, sizeof(v80_sp.slots));
            memcpy(insp_stockpiles[i].reservedBy, v80_sp.reservedBy, sizeof(v80_sp.reservedBy));
            memcpy(insp_stockpiles[i].slotCounts, v80_sp.slotCounts, sizeof(v80_sp.slotCounts));
            memcpy(insp_stockpiles[i].slotTypes, v80_sp.slotTypes, sizeof(v80_sp.slotTypes));
            memcpy(insp_stockpiles[i].slotMaterials, v80_sp.slotMaterials, sizeof(v80_sp.slotMaterials));
            insp_stockpiles[i].maxStackSize = v80_sp.maxStackSize;
            insp_stockpiles[i].priority = v80_sp.priority;
            insp_stockpiles[i].maxContainers = v80_sp.maxContainers;
            memcpy(insp_stockpiles[i].slotIsContainer, v80_sp.slotIsContainer, sizeof(v80_sp.slotIsContainer));
            memcpy(insp_stockpiles[i].groundItemIdx, v80_sp.groundItemIdx, sizeof(v80_sp.groundItemIdx));
    ...
    if (version < 78) {
        for (int i = 0; i < insp_moverCount; i++) {
            insp_movers[i].equippedClothing = -1;
        }
    }
