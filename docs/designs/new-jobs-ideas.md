currenlty we have, *building* walls, *digging* walls,

i also want *channeling* (which removes the block z-1 level)
...
oh wow here we have the labor wikipedia fromm dwarf fortress and proficiences from cataclyms:
https://dwarffortresswiki.org/index.php/DF2014:Labor

| Category              | Labors                  | Quality-effects? | Details                                                                   |
|-----------------------|-------------------------|------------------|---------------------------------------------------------------------------|
| Mining                | Mining                  |                  |                                                                           |
| Mining                | Mining                  | no               | speed only                                                                |
| Woodworker            | Carpentry               | yes              | item, furniture, and designed building quality                            |
| Woodworker            | Crossbow-making         | yes              | weapon quality                                                            |
| Woodworker            | Wood cutting            | no               | speed only                                                                |
| Stoneworking          | Masonry                 | yes              | item, furniture, and designed building quality                            |
| Stoneworking          | Stone detailing         | yes              | engraving quality, speed only for smoothing and track carving             |
| Hunting/Related       | Animal training         | yes              | training quality                                                          |
| Hunting/Related       | Animal care             | no               | not implemented                                                           |
| Hunting/Related       | Hunting                 | no               | success rate tends to rise from increasing ambusher and marksdwarf skills |
| Hunting/Related       | Trapping                | no               | success rate? trap quality?[Verify]                                       |
| Hunting/Related       | Small animal dissection | no               | speed only                                                                |
| Healthcare (Doctoral) | Diagnosis               | yes              | success chance, accuracy (and speed) of treatment                         |
| Healthcare (Doctoral) | Surgery                 | yes              | success chance, accuracy (and speed) of treatment                         |
| Healthcare (Doctoral) | Setting bones           | yes              | success chance, accuracy (and speed) of treatment                         |
| Healthcare (Doctoral) | Suturing                | yes              | success chance, accuracy (and speed) of treatment                         |
| Healthcare (Doctoral) | Dressing wounds         | yes              | success chance, accuracy (and speed) of treatment                         |
| Healthcare (Nursing)  | Feed patients/prisoners | no               | unskilled                                                                 |
| Healthcare (Nursing)  | Recovering wounded      | no               | unskilled                                                                 |
| Farming/Related       | Butchery                | no               | speed only                                                                |
| Farming/Related       | Tanning                 | no               | speed only                                                                |
| Farming/Related       | Farming (fields)        | yes              | crop yield (stack size)                                                   |
| Farming/Related       | Dyeing                  | yes              | dye quality                                                               |
| Farming/Related       | Gelding                 | no               | less likely to be injured                                                 |
| Farming/Related       | Soap making             | no               | speed only                                                                |
| Farming/Related       | Wood burning            | no               | speed only                                                                |
| Farming/Related       | Potash making           | no               | speed only                                                                |
| Farming/Related       | Lye making              | no               | speed only                                                                |
| Farming/Related       | Milling                 | no               | speed only                                                                |
| Farming/Related       | Brewing                 | no               | speed only                                                                |
| Farming/Related       | Plant gathering         | yes              | success and plant yield (stack size)                                      |
| Farming/Related       | Plant processing        | no               | speed only                                                                |
| Farming/Related       | Cheese making           | no               | speed only                                                                |
| Farming/Related       | Milking                 | no               | speed only                                                                |
| Farming/Related       | Shearing                | no               | speed only                                                                |
| Farming/Related       | Spinning                | no               | speed only                                                                |
| Farming/Related       | Cooking                 | yes              | meal and ingredient quality                                               |
| Farming/Related       | Pressing                | no               | speed only                                                                |
| Farming/Related       | Beekeeping              | no               | speed only[Verify]                                                        |
| Fishing/Related       | Fishing                 | yes              | fish stack size                                                           |
| Fishing/Related       | Fish cleaning           | no               | speed only                                                                |
| Fishing/Related       | Fish dissection         | no               | speed only                                                                |
| Metalsmithing         | Furnace operating       | no               | speed only                                                                |
| Metalsmithing         | Weaponsmithing          | yes              | weapon quality                                                            |
| Metalsmithing         | Armoring                | yes              | armor quality                                                             |
| Metalsmithing         | Blacksmithing           | yes              | item, furniture, designed building quality                                |
| Metalsmithing         | Metalcrafting           | yes              | craft, item, decoration, designed building quality                        |
| Jewelry               | Gem cutting             | yes              | gem craft quality                                                         |
| Jewelry               | Gem setting             | yes              | decoration quality                                                        |
| Crafts                | Leatherworking          | yes              | clothing, decoration, craft quality                                       |
| Crafts                | Woodcrafting            | yes              | craft quality                                                             |
| Crafts                | Stonecrafting           | yes              | craft quality                                                             |
| Crafts                | Bone carving            | yes              | craft, decoration quality                                                 |
| Crafts                | Glassmaking             | yes              | craft, item, furniture quality                                            |
| Crafts                | Weaving                 | yes              | cloth quality                                                             |
| Crafts                | Clothesmaking           | yes              | clothing, decoration quality                                              |
| Crafts                | Strand extraction       | no               | speed only                                                                |
| Crafts                | Pottery                 | yes              | craft, item, furniture quality                                            |
| Crafts                | Glazing                 | yes              | glaze quality                                                             |
| Crafts                | Wax working             | yes              | craft quality                                                             |
| Engineering           | Siege engineering       | yes              | part, ammunition quality                                                  |
| Engineering           | Siege operating         | yes              | accuracy                                                                  |
| Engineering           | Mechanics               | yes              | mechanism, furniture quality                                              |
| Engineering           | Pump operating          | no               | -                                                                         |
| Hauling               | Stone hauling           | no               | unskilled                                                                 |
| Hauling               | Wood hauling            | no               | unskilled                                                                 |
| Hauling               | Item hauling            | no               | unskilled                                                                 |
| Hauling               | Burial                  | no               | unskilled                                                                 |
| Hauling               | Food hauling            | no               | unskilled                                                                 |
| Hauling               | Refuse hauling          | no               | unskilled                                                                 |
| Hauling               | Furniture hauling       | no               | unskilled                                                                 |
| Hauling               | Animal hauling          | no               | unskilled                                                                 |
| Hauling               | Trade Good Hauling      | no               | unskilled                                                                 |
| Hauling               | Water Hauling           | no               | unskilled                                                                 |
| Hauling               | Push/Haul Vehicle       | no               | unskilled                                                                 |
| Other Jobs            | Architecture            | yes              | building design quality                                                   |
| Other Jobs            | Alchemy                 | no               | not implemented                                                           |
| Other Jobs            | Cleaning                | no               | unskilled                                                                 |
| Other Jobs            | Lever operation         | no               | unskilled                                                                 |
| Other Jobs            | Road building           | no               | unskilled                                                                 |
| Other Jobs            | Wall/floor construction | no               | unskilled                                                                 |
| Other Jobs            | Construction removal    | no               | unskilled                                                                 |
