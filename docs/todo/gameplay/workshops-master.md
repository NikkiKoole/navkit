...
Full design: `docs/todo/gameplay/water-dependent-crafting.md`

Workshops requiring location-based resource access (water, dryness). Includes mud mixer, brick drying yard, wattle frame builder, mason's bench. Enables mud/cob/wattle construction without container system.
